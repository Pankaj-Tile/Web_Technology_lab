...
<body>
	...
	try {
		...
		if(SUBMIT==null) {
			...
			int i = st.executeUpdate("insert into wt_ass_5(username,firstname,lastname,password) values ('"+username+"','"+first_name+"', '"+last_name+"', '"+password+"')");
			...
			int i = st.executeUpdate("delete from wt_ass_5 where firstname = '"+first_name+"'");
			if(i>0) {
			...
			int i = st.executeUpdate("update wt_ass_5 SET firstname = '"+first_name+"' where lastname = '"+last_name+"'");
			if(i>0) {
